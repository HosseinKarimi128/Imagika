...
from contlika.api_router import *
...
def get_celestial() -> FastAPI:
	...
	app.include_router(celestial_router, prefix=settings.API_V1_STR)
...
def get_davinchi() -> FastAPI:
	...
	app.state.arbitrary_types_allowed = True
	# Include all api endpoints
	app.include_router(davinchi_router, prefix=settings.API_V1_STR)
...
celestial = get_celestial()
davinchi = get_davinchi()