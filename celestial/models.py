...
class Post(models.Model):
    ...
    uploaded_image: str = models.UUIDField(null=True, default=None)
    generated_images: List = ArrayField(models.UUIDField(), null=True, editable=False)
    ...
    image: str = models.UUIDField(null=True, default=None)
